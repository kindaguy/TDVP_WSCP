...
(sysenv,psi0) = defineSystem(sys_type = "S=1/2",sys_istate = "Up",chain_size = 250, local_dim = 6);
...
tdvp!(psi,H,timestep,tmax,maxdim=20,callback=cbT, progress=false,cutoff=10e-12,io_file="critico.dat",store_psi0 = true)
